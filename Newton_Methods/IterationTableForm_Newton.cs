...
namespace Optimization_methods.Newton_Methods
{
    public partial class IterationTableForm_Newton : Form
    {
        ...
        {// Очистка существующих строк в DataGridView
            ...
            dataGridView.Rows.Add(iteration, x_0, x_k, CalculateFunctionValue(x_0), CalculateDerivative(x_0), CalculateSecondDerivative(x_0), epsilon);
            ...
            while (epsilon > accuracy)
            {
                ...
                dataGridView.Rows.Add(iteration, x_k, x_k_plus_1, f, f_prime_x_k, f_double_prime_x_k, epsilon);
